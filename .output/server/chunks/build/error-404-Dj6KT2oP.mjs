...
import {
  ...
  l as hasProtocol,
  n as joinURL,
  x as withTrailingSlash,
  y as withoutTrailingSlash,
} from "../runtime.mjs";
import {
  _ as _export_sfc,
  u as useRouter,
  n as nuxtLinkDefaults,
  r as resolveRouteObject,
  a as navigateTo,
  b as useNuxtApp,
  c as useRuntimeConfig,
} from "./server.mjs";
import {
  ssrRenderAttrs,
  ssrInterpolate,
...
function defineNuxtLink(options) {
  ...
  function resolveTrailingSlashBehavior(to, resolve) {
    ...
    const path =
      "path" in to && to.path !== void 0 ? to.path : resolve(to).path;
    const resolvedPath = {
      ...to,
      name: void 0,
  ...
  function useNuxtLink(props) {
    ...
    const isAbsoluteUrl = computed(() => {
      ...
      return (
        typeof path === "string" && hasProtocol(path, { acceptRelative: true })
      );
    });
    ...
    const link = isExternal.value
      ? void 0
      : useBuiltinLink == null
        ? void 0
        : useBuiltinLink({ ...props, to });
    const href = computed(() => {
      var _a3;
      var _a2;
      ...
      if (isExternal.value) {
        const path =
          typeof to.value === "object" && "path" in to.value
            ...
            : to.value;
        const href2 =
          typeof path === "object" ? router.resolve(path).href : path;
      ...
      if (typeof to.value === "object") {
        return (_a3 =
          (_a2 = router.resolve(to.value)) == null ? void 0 : _a2.href) != null
          ? _a3
          : null;
      }
      return resolveTrailingSlashBehavior(
    ...
    return {
      ...
      href,
      isActive:
        (_a = link == null ? void 0 : link.isActive) != null
          ? _a
          : computed(() => to.value === router.currentRoute.value.path),
      isExactActive:
        (_b = link == null ? void 0 : link.isExactActive) != null
          ? _b
          : computed(() => to.value === router.currentRoute.value.path),
      route:
        (_c = link == null ? void 0 : link.route) != null
          ? _c
          : computed(() => router.resolve(to.value)),
      async navigate() {
  ...
  return defineComponent({
    ...
    setup(props, { slots }) {
      const router = useRouter();
      const { to, href, navigate, isExternal, hasTarget, isAbsoluteUrl } =
        useNuxtLink(props);
      ...
      function shouldPrefetch(mode) {
        ...
        return (
          !prefetched.value &&
          (typeof props.prefetchOn === "string"
            ? props.prefetchOn === mode
            : (_a2 = (_a = props.prefetchOn) == null ? void 0 : _a[mode]) !=
                null
              ? _a2
              : (_b = options.prefetchOn) == null
                ? void 0
                : _b[mode]) &&
          ((_b2 = props.prefetch) != null ? _b2 : options.prefetch) !== false &&
      ...
      return () => {
        ...
        return h(
          "a",
          { ref: el, href: href.value || null, rel, target },
...
function applyTrailingSlashBehavior(to, trailingSlash) {
  const normalizeFn =
    trailingSlash === "append" ? withTrailingSlash : withoutTrailingSlash;
  const hasProtocolDifferentFromHttp =
    hasProtocol(to) && !to.startsWith("http");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        `<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-00b6b518><div class="fixed left-0 right-0 spotlight z-10" data-v-00b6b518></div><div class="max-w-520px text-center z-20" data-v-00b6b518><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-00b6b518>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-00b6b518>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-00b6b518>`,
      );
      _push(
        ssrRenderComponent(
          _component_NuxtLink,
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [
  ["__scopeId", "data-v-00b6b518"],
]);
