import { _ as s, t as r, v as p, x as t, B as e, J as h } from "./BqwCoySn.js";
const x = { name: "NuxtTutorial" },
  C = {
    class:
      "relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0",
  };
function g(o, a, n, c, i, l) {
  return (
    r(),
    p(
      "div",
          ...
          t(
            ...
            [
              ...
              t(
                ...
                {
                  class:
                    "mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6",
                },
                [
                  t(
                    "h2",
                  ...
                  t("p", { class: "mt-3 text-gray-600" }, [
                    e(" We recommend you take a look at the "),
                    t(
                      "a",
                      {
                        href: "https://nuxtjs.org",
              ...
              t("div", { class: "flex justify-center pt-4 space-x-2" }, [
                t(
                  "a",
                  { href: "https://github.com/nuxt/nuxt.js", target: "_blank" },
                  [
                    t(
                      "svg",
                      {
                        class:
                          "w-6 h-6 text-gray-600 hover:text-gray-800 button--github",
                        xmlns: "http://www.w3.org/2000/svg",
                ...
                t(
                  "a",
                  { href: "https://twitter.com/nuxt_js", target: "_blank" },
                  [
                    t(
                      "svg",
                      {
...
const m = s(x, [["render", g]]),
  u = { name: "IndexPage" };
function w(o, a, n, c, i, l) {
  const d = m;
  return r(), h(d);
}
const v = s(u, [["render", w]]);
export { v as default };
